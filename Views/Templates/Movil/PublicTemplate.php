...
<html lang="en">
    ...
    <body class="bg-light">
        ...
        <div class="row" id="header-public">
            <div class="col">
                <a href="#inicio" class="text-dark">Inicio</a><br><br>
                <a href="#contacta" class="text-dark">Contacto</a><br><br>
                <a href="#pedido" class="btn btn-outline-primary">Estado de Pedido</a><br><br>
